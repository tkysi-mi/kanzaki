...
> あらゆるアウトプットの品質を、自分で定義したルールでチェックする staged changes レビューツール

## Kanzaki とは

**Kanzaki** は、git の staged changes を LLM（大規模言語モデル）でレビューする CLI ツールです。pre-commit フック、開発中の手動チェック、CI/CD で利用できます。
